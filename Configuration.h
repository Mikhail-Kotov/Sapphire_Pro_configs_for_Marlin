...
#define STRING_CONFIG_H_AUTHOR "(Misha Kotov)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  10.45,  22.20 }
    #define DEFAULT_Ki_LIST {   0.49,   1.08 }
    #define DEFAULT_Kd_LIST {  55.51, 114.00 }
  #else
    #define DEFAULT_Kp   10.45
    #define DEFAULT_Ki    0.49
    #define DEFAULT_Kd   55.51
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //Sapphire Pro
  #define DEFAULT_bedKp 51.50
  #define DEFAULT_bedKi 7.83
  #define DEFAULT_bedKd 51.50
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.3, 80.3, 1600, 820 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, -10.4, 0 }
